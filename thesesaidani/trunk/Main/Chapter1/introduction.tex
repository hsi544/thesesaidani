...
La question qui se pose alors est celle de la limite de l'amélioration des processeurs par l'augmentation de leur fréquence d'horloge. Alors que la loi de \emph{Moore} \cite{Moore_1965} prédit une augmentation exponentielle, les dernières années ont montré que nous approchions la saturation. Par conséquent, cette augmentation de fréquence doit éventuellement ralentir voire même s'arrêter.\\
