...
Pour les développeurs, l'augmentation de la fréquence d'horloge des processeurs fut souvent par le passé, synonyme d'amélioration des programmes sans en modifier la moindre ligne de code source. Hélas, cette affirmation n'est plus valable à l'heure où on parle, et elle ne sera pas non plus dans le futur proche.\\
Les architectures vont évidemment continuer à évoluer et à améliorer leurs performances, mais l'amélioration de logiciels ne se fera plus de manière aussi systématique que par le passé. En effet, les évolutions architecturales ont changé de direction et s'orientent désormais vers une multiplication des unités de calcul et une coordination plus efficace de leur exécution concurrente pour améliorer les performances des programmes.
