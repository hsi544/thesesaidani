...
\paragraph{Parallélisme à Grain Fin (Fine-Grain)}
Dans ce cas là le ratio calcul/communication est faible et les opportunités d?optimisation. L?équilibrage de charge est alors simplifié puisque les  tâches passent la majorité du temps en communications et pas en calcul.\paragraph{Parallélisme à Grain Moyen (Coarse-Grain)}
