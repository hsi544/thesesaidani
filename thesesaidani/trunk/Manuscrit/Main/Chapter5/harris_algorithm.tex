...
Ce chapitre aborde dans le détail, la démarche de parallélisation d'un exemple de code de traitement d'images sur le processeur Cell. Tout au long de cette étude, plusieurs aspects de l'optimisation sont traités. D'une part les optimisations spécifiques au traitement d'images et d'autre part ceux spécifiques au processeur Cell et ces différents niveaux de parallélisme.\\
