...
Les second facteur qui influe sur l'efficacité du réseau lors des transferts est le nombre de transferts s'exécutante en parallèle. En effet, l'architecture du réseau dont la topologie est tu type \emph{token ring} contient qautre anneaux d'une largeur de 128-bit : deux dans le sens d'une aiguille d'une montre et les deux autres dans le sens contraire \ref{fignoc}
\begin{figure}[!htb]
  \centering
