...
$Q = (h+2 \times b)\times(w+2\times b)\times nb_{tiles}$\\\\
...
$Q = (h+2 \times b)\times(w+2\times b)\times\frac{H \times W}{h \times w}$\\\\
Posons alors $\lambda = h \times w = C^{te}$, la fonction à minimiser devient alors : \\\\
$Q = (h+2 \times b)\times(w+2\times b)\times\frac{H \times W}{\lambda}$\\\\
