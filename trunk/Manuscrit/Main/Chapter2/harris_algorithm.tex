...
Les tuile que l'on traite dans notre cas sont en général d'une forme rectangulaire. Toutefois, à cause de la présence d'opérateurs de convolution, un nouvel aspect doit être considéré qui sont les dimensions hauteur et largeur de la tuile ($h$ et $w$).
