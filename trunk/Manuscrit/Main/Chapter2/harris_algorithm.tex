...
\multicolumn{6}{c}{\textbf{Complexité sans Séparation des Noyaux}}\\
\hline
\multicolumn{3}{|c||}{\emph{Filtre de Sobel}} & \multicolumn{3}{|c|}{\emph{Filtre de Gauss}}\\
\hline
\textbf{\texttt{MUL}} & \textbf{\texttt{ADD}} & \textbf{Total}& \textbf{\texttt{MUL}} & \textbf{\texttt{ADD}} & \textbf{Total} \\
\hline
 8  & 5 &16  & 2  & 5 &16 \\
\hline
3  & 0 &3   &2  & 5 &16\\
...
\end{tabular}
\begin{tabular}{|c|c|c||c|c|c|}
\multicolumn{6}{c}{\textbf{Complexité avec Séparation des Noyaux}}\\
\hline
\multicolumn{3}{|c||}{\emph{Filtre de Sobel}} & \multicolumn{3}{|c|}{\emph{Filtre de Gauss}}\\
\hline
\textbf{\texttt{MUL}} & \textbf{\texttt{ADD}} & \textbf{Total}& \textbf{\texttt{MUL}} & \textbf{\texttt{ADD}} & \textbf{Total} \\
