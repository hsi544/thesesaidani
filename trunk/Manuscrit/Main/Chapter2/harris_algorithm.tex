...
\begin{itemize}
\item Nos techniques d'optimisations des accés mémoires améliorent sensiblement la performance globale car la versions pla plus rapide est celle ou les fonctions sont composées deux par deux  et ou tous les opérateurs sont exécutés sur le même SPE (remplacement des DMA par des \texttt{LOAD/STORE} ).
