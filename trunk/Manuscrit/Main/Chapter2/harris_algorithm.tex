...
[Mettre figure ici]\\
Un tableau similaire au tableau \ref{tab_sepa} donne la différence en terme de complexité arithmétique entre la version de base de l'algorithme est la version tenant compte de la réduction et de la factorisation des calculs.
[A Compélter]\\
\subsubsection{Schémas de Parallélisation}
...
\paragraph{Chaînage d'opérateur par paires}
\begin{figure}[!htb]
	\centering
...
\paragraph{Chaînage et fusion d'opérateur par paires}
\paragraph{Chaînage d'opérateur par paires}
\begin{figure}[!htb]
	\centering
...
\paragraph{Chaînage entier et fusion d'opérateur par paires}
\begin{figure}[!htb]
	\centering
