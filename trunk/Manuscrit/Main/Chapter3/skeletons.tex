...
<<<<<<< .mine
\section{Le Squelette \textbf{Pardo}}
\section{Le Squelette \textbf{Pipeline}}
\section{Le Squelette \textbf{Sequence}}
\section{Le Squelette \textbf{Chain}}
...
\begin{figure}[!htb]
	\centering
  \includegraphics[width= 0.2\columnwidth]{Chapter3/figures/skell-pardo}
